...
static void at91_mci_enable()
{
	...
	mr = AT91_MCI_PDCMODE | 0x354;

#ifndef RT_AT91AM9261S
...
#ifdef RT_AT91SAM9261S
	/* 9261S is only used slot a */
	rt_kprintf("Use slot a\n");
	at91_mci_write(AT91_MCI_SDCR, 0); /* use slot a */
#else
	rt_kprintf("Use slot b\n");
...
{
	at91_sys_write(AT91_PIOA + PIO_PUER, (1 << 0)|(1 << 1)|(1 << 4)|(1 << 5)|(1 << 6));
	at91_sys_write(AT91_PIOA + PIO_PUDR, (1 << 2));
	at91_sys_write(AT91_PIOA + PIO_BSR, (1 << 0)|(1 << 1)|(1 << 2)|(1 << 4)|(1 << 5)|(1 << 6));
	at91_sys_write(AT91_PIOA + PIO_PDR, (1 << 0)|(1 << 1)|(1 << 2)|(1 << 4)|(1 << 5)|(1 << 6));
